...
function Stage:build()
    colorShaderBF = love.graphics.newShader("assets/shaders/adjustColor.glsl")
    colorShaderDad = love.graphics.newShader("assets/shaders/adjustColor.glsl")
    colorShaderGF = love.graphics.newShader("assets/shaders/adjustColor.glsl")
