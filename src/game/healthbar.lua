...
function healthbar:new(p1, p2)
    ...
    self.p1Icon = weeks:preloadIcon(p1 or (weeks.enemy and weeks.enemy.healthIcon) and weeks.enemy.healthIcon or "dad", "enemy", (weeks.enemy and weeks.enemy.healthIconScale) or 1)
    self.p2Icon = weeks:preloadIcon(p2 or (weeks.boyfriend and weeks.boyfriend.healthIcon) and weeks.boyfriend.healthIcon or "boyfriend", "boyfriend", (weeks.boyfriend and weeks.boyfriend.healthIconScale) or 1)
