...
return {
	enter = function(self, from)
        ...
        enemy = BaseCharacter("assets/sprites/characters/boyfriend-pixel.lua")
	...
	load = function(self, DONT_GENERATE)
	    ...
	    inst = love.audio.newSource("assets/songs/test/Inst.ogg", "stream")
		voicesBF = love.audio.newSource("assets/songs/test/Voices-bf.ogg", "stream")
        voicesEnemy = love.audio.newSource("assets/songs/test/Voices-bf-pixel.ogg", "stream")
	...
	initUI = function(self)
		...
		weeks:legacyGenerateNotes("assets/data/songs/test/test.lua")
	end,
